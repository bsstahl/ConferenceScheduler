...
namespace Optimizer.DataSetsTest
{
    ...
    [TestFixture]
    public class SoCalCodeCampSanDiego2017Fluent
    {
        [Test]
        public void ScheduleWithoutPreferences()
        {
            ...
            var topics = new TopicBuilder().Add(
                "SoftSkills", "IOT", "Python", "Agile",
                "AI", "Mobile", "Cloud", "Blockchain",
                "DevOps", "Angular", "Javascript", "DotNetCore",
                "BI", "ReactRedux", "IOTLab").Build();
            ...
            var session04 = sessions.Add(4, topics["Python"], presenterTreyHunner);

            var session05 = sessions.Add(5, null, presenterMichaelLebo);

            var session06 = sessions.Add(6, topics["Agile"], presenterAaronRuckman);

            var session07 = sessions.Add(7, topics["AI"], presenterDanielEgan);

            var session08 = sessions.Add(8, topics["Mobile"], presenterLorraineKan);

            var session09 = sessions.Add(9, topics["Agile"], presenterChrisLucian);

            var session10 = sessions.Add(10, topics["IOT"], presenterBretStateham);

            var session11 = sessions.Add(11, topics["Cloud"], presenterRobinShahan);

            var session12 = sessions.Add(12, topics["SoftSkills"], presenterJustinJames);

            var session13 = sessions.Add(13, topics["Blockchain"], presenterTobiasHughes);

            var session14 = sessions.Add(14, null, presenterWendySteinman);

            var session15 = sessions.Add(15, topics["Angular"], presenterOgunTigli);

            var session16 = sessions.Add(16, topics["Mobile"], presenterHibaMughal);

            var session17 = sessions.Add(17, topics["Mobile"], presenterEricFloe);

            var session18 = sessions.Add(18, topics["Javascript"], presenterHattanShobokshi);

            var session19 = sessions.Add(19, topics["Mobile"], presenterJonBachelor);

            var session20 = sessions.Add(20, topics["DotNetCore"], presenterPaulWhitmer);

            var session21 = sessions.Add(21, topics["Javascript"], presenterDavidFord);

            var session22 = sessions.Add(22, topics["BI"], presenterVaziOkhandiar);

            var session23 = sessions.Add(23, topics["Javascript"], presenterChrisStead);

            var session24 = sessions.Add(24, topics["Blockchain"], presenterRyanMilbourne);
            var session25 = sessions.Add(25, topics["Blockchain"], presenterRyanMilbourne);

            var session26 = sessions.Add(26, topics["Javascript"], presenterJustinJames);
            var session27 = sessions.Add(27, topics["Mobile"], presenterJustinJames);

            var session28 = sessions.Add(28, topics["ReactRedux"], presenterMaxNodland);
            var session29 = sessions.Add(29, topics["ReactRedux"], presenterMaxNodland);

            var session30 = sessions.Add(30, topics["AI"], presenterBarryStahl);

            var session31 = sessions.Add(31, topics["AI"], presenterJustineCocci);
            var session32 = sessions.Add(32, topics["AI"], presenterJustineCocci);

            var session33 = sessions.Add(33, topics["DevOps"], presenterHattanShobokshi);

            var session34 = sessions.Add(34, topics["Mobile"], presenterChrisGriffith);

            var session35 = sessions.Add(35, topics["IOTLab"], presenterIotLaboratory);
            var session36 = sessions.Add(36, topics["IOTLab"], presenterIotLaboratory);
            var session37 = sessions.Add(37, topics["IOTLab"], presenterIotLaboratory);
            var session38 = sessions.Add(38, topics["IOTLab"], presenterIotLaboratory);
            var session39 = sessions.Add(39, topics["IOTLab"], presenterIotLaboratory);
            var session40 = sessions.Add(40, topics["IOTLab"], presenterIotLaboratory);
